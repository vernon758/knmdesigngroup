...
const notificationSound = new Audio('notification.mp3'); // Add your notification sound
...
// Show/hide chat box on button click
chatButton.addEventListener('click', () => {
  chatBox.style.display = chatBox.style.display === 'flex' ? 'none' : 'flex';
  redDot.style.display = 'none'; // Hide red dot
  chatPopup.style.display = 'none'; // Hide popup
});
